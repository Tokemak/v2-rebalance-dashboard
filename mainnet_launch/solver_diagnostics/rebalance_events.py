...
# def fetch_and_render_rebalance_events_data(autopool: AutopoolConstants) -> go.Figure:
#     rebalance_figures = fetch_rebalance_events_data(autopool)
#     # TODO I don't like using subplots, instead just make several plots
#     st.header(f"{autopool.name} Rebalance Events")
#     st.plotly_chart(rebalance_figures, use_container_width=True)
...
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=clean_rebalance_df["outEthValue"], name="Out ETH Value"), row=2, col=1
#     )
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=clean_rebalance_df["inEthValue"], name="In ETH Value"), row=2, col=1
#     )
...
#     )
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=clean_rebalance_df["swapCost"], name="Swap Cost"), row=3, col=1
#     )
...
#     swap_cost_percentage = (clean_rebalance_df["slippage"]) * 100
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=swap_cost_percentage, name="Swap Cost Percentage"), row=4, col=1
#     )
...
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=clean_rebalance_df["break_even_days"], name="Break Even Days"),
#         row=5,
#         col=1,
#     )
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=clean_rebalance_df["offset_period"], name="Offset Period"), row=5, col=1
#     )
...
#     fig.add_trace(
#         go.Bar(x=clean_rebalance_df.index, y=solver_profit_after_gas_costs, name="Solver Profit After Gas"),
#         row=6,
#         col=1,
#     )
