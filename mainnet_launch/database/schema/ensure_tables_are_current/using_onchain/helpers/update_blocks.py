...
"""
We need the top and bottom block of each day. Exact top and exact bottom block are not necessary, as long as there is at least 23:59 minutes 
between the top and bottom block timestamps for each day it si good enough

This is because some blocks
