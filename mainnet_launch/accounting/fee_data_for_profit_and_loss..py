...
from mainnet_launch.data_fetching.new_databases import write_dataframe_to_table, load_table, run_read_only_query, does_table_exist
...
def fetch_fee_df():
    ...
    # can adda  where caluse here when we don't want to have fees from more than X days ago
