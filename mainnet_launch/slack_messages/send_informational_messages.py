...
def post_daily_messages(slack_channel: SlackChannel):
...
def post_weekly_messages(slack_channel: SlackChannel):
    """Notifications that about the general state of the autopool, but don't require immediate action"""
