...
from .chains import *
from .secrets import S3_BUCKETS
...
AUTO_ETH = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["AUTO_ETH2"],  # the new bucket is here
    chain=ETH_CHAIN,
...
BAL_ETH = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["BAL_ETH"],
    chain=ETH_CHAIN,
    base_asset=WETH(ETH_CHAIN),
...
AUTO_LRT = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["AUTO_LRT"],
    chain=ETH_CHAIN,
    base_asset=WETH(ETH_CHAIN),
...
BASE_ETH = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["BASE_ETH"],
    chain=BASE_CHAIN,
...
DINERO_ETH = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["DINERO_ETH"],
    chain=ETH_CHAIN,
    base_asset=WETH(ETH_CHAIN),
...
AUTO_USD = AutopoolConstants(
    ...
    solver_rebalance_plans_bucket=S3_BUCKETS["AUTO_USD"],
    chain=ETH_CHAIN,
...
BASE_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["BASE_USD"],
    chain=BASE_CHAIN,
...
AUTO_DOLA = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["AUTO_DOLA"],
    chain=ETH_CHAIN,
...
SONIC_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["SONIC_USD"],
    chain=SONIC_CHAIN,
...
SILO_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["SILO_USD"],
    chain=ETH_CHAIN,
    base_asset=USDC(ETH_CHAIN),
...
SILO_ETH = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["SILO_ETH"],
    chain=ETH_CHAIN,
    base_asset=WETH(ETH_CHAIN),
...
BASE_EUR = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["BASE_EUR"],
    chain=BASE_CHAIN,
...
ARB_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["ARB_USD"],
...
PLASMA_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["PLASMA_USD"],
    chain=PLASMA_CHAIN,
...
LINEA_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["LINEA_USD"],
    chain=LINEA_CHAIN,
...
ANCHRG_USD = AutopoolConstants(
    ...
    autopool_eth_strategy_addr=None,
    solver_rebalance_plans_bucket=S3_BUCKETS["ANCHRG_USD"],
    chain=ETH_CHAIN,
    base_asset=USDC(ETH_CHAIN),
