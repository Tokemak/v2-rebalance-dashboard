...
stables = [DAI, USDe, USDC, USDT, USDs, GHO, scrvUSD, sUSDe, crvUSD, sUSDs]
...
dai_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(DAI, "DAI", 18),
)
...
usde_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(USDe, "USDe", 18),
)
usdc_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(USDC, "USDC", 6),
)
...
usdt_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(USDT, "USDT", 6),
)
...
usds_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(USDs, "USDs", 18),
)
...
gho_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(GHO, "GHO", 18),
)
...
crvUSD_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(crvUSD, "crvUSD", 18),
)
...
scrvUSD_constants = StableCoinConsants(
    ...
    spot_price_calls=make_curve_get_best_rate_call(scrvUSD, "scrvUSD", 18),
)
...
sUSDe_constants = StableCoinConsants(
    ...
    safe_price_call=None,
    spot_price_calls=make_curve_get_best_rate_call(sUSDe, "sUSDe", 18),
)
...
sUSDs_constants = StableCoinConsants(
    ...
    safe_price_call=None,
    spot_price_calls=make_curve_get_best_rate_call(sUSDs, "sUSDs", 18),
)
